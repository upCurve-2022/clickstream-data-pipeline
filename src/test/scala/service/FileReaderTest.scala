...
import helper.Helper.{CLICK_STREAM_TEST_INPUT_PATH, INPUT_TEST_FILE_FORMAT}
...
class FileReaderTest extends AnyFlatSpec {
  ...
  "file reader " should "return a return a dataframe with records " in {
    ...
    val outputDF = service.FileReader.fileReader(CLICK_STREAM_TEST_INPUT_PATH, INPUT_TEST_FILE_FORMAT )
